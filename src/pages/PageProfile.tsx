...
export const PageProfile = () => {
	...
	return (
		<>
			{showLoginMessage ? (
				<p>Thank you for changing your profile data. Please log out and log in again.</p>
			) : (
				<>
